"""
Django settings for dry_heart_45674 project.
...
ROOT_URLCONF = 'dry_heart_45674.urls'
...
WSGI_APPLICATION = 'dry_heart_45674.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_heart_45674 API",
    "DESCRIPTION": "API documentation for dry_heart_45674 App",
    "VERSION": "v1",
}
